package org.openmrs.module.dssmodule.lexer;
...
public class Lexer {
    ...
    private Token getNum() {
        String num = getInt();
        if (ch != '.') {
            return newNumberToken(num, startPosition, endPosition);
        }
        endPosition++;
        num += '.';
        try {
    ...
    private String getInt() { // return a string of digits found on input
        String s = "";
