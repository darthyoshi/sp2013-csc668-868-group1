package org.openmrs.module.basicmodule.dsscompiler.visitor;
 ...
 * its visit; <br> each subclass <b>must</b> provide all of the visitors
 * mentioned in this class; <br> after visiting a tree the visitor can return
 * any Object of interest<br> e.g. when the constrainer visits an expression
 * tree it will return a reference to the type tree representing the type of the
 * expression
 */
public abstract class ASTVisitor {
    ...
    public abstract Object visitObjectDeclTree(AST t);
    ...
    public abstract Object visitLiteralTree(AST t);

    public abstract Object visitIdTree(AST t);

    public abstract Object visitObjectTree(AST t);

    public abstract Object visitOpTree(AST t);

     public abstract Object visitFieldRefTree(AST t);

    public abstract Object visitListTree(AST t);

    public abstract Object visitElsifTree(AST t);
}